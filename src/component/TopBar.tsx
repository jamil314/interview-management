...
import { Button, Tooltip, notification, Space, InputRef, Input, Table, Empty } from 'antd';
  ...
  return (
    <div className={topBar.topBar}>
        ...
        <div style={{whiteSpace : 'nowrap'}} className={topBar.scrollParent}>
          ...
          <a className={topBar.scrollElement} style={{left : '100%'}}>{notification}</a>
        </div>
        <div> <Tooltip title="Visit Profile">
