  ...
  return (
    <div className={status.flipCard} onClick={assignInterviewer}>
      <div className={status.flipInner}>
        <div className={status.flipFront}>Pending</div>
        <div className={status.flipBack}>Assign {step}th interviewer</div>
      </div>
    </div>
  );
};
    ...
    <div className={status.pageFill} onClick={() => resetFocus()}>
      <div className={status.info}>
        ...
        <div className={status.note} onClick={(e) => e.stopPropagation()}>
          ...
          <p>
            Batting : <Rate defaultValue={5.5} disabled allowHalf count={7} />{" "}
          </p>
          <p>
            Bowling : <Rate defaultValue={4.5} disabled allowHalf count={7} />{" "}
          </p>
          <p>
            Feilding : <Rate defaultValue={5} disabled allowHalf count={7} />{" "}
          </p>
          <p>
            Communication :{" "}
            <Rate defaultValue={6} disabled allowHalf count={7} />{" "}
          </p>
        </div>
      </div>
      {assign ? (
        <>
          <Button
            shape="circle"
            className={status.closeInterviewrSelection}
            onClick={(e) => {
              e.stopPropagation();
              setAssign(false);
            }}
